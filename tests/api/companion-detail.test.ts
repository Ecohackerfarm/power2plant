...
describe('GET /api/plants/[id]/companions/[companionId]', () => {
  ...
  it('returns relationship with non-community sources', async () => {
    ...
    vi.mocked(prisma.relationshipSource.findMany).mockResolvedValue([
      { id: 'src-1', relationshipId: 'rel-1', source: 'TREFLE', sourceType: null, confidence: 'OBSERVED', url: 'https://trefle.io', notes: null, fetchedAt: new Date('2025-01-01'), userId: null, position: null },
    ])
  ...
  it('groups community sources by user+day', async () => {
    vi.mocked(prisma.$queryRaw).mockResolvedValue([fakeRel])
    vi.mocked(prisma.relationshipSource.findMany).mockResolvedValue([
      { id: 'src-2', relationshipId: 'rel-1', source: 'COMMUNITY', sourceType: null, confidence: 'ANECDOTAL', url: null, notes: 'I grew these together', fetchedAt: new Date('2025-06-01T10:00:00Z'), userId: 'user-1', position: null },
      { id: 'src-3', relationshipId: 'rel-1', source: 'COMMUNITY', sourceType: 'SCIENTIFIC_PAPER', confidence: 'PEER_REVIEWED', url: 'https://doi.org/10.1234', notes: null, fetchedAt: new Date('2025-06-01T10:01:00Z'), userId: 'user-1', position: null },
      { id: 'src-4', relationshipId: 'rel-1', source: 'COMMUNITY', sourceType: 'GARDENING_GUIDE', confidence: 'TRADITIONAL', url: 'https://rhs.org.uk/guide', notes: null, fetchedAt: new Date('2025-06-01T10:02:00Z'), userId: 'user-1', position: null },
    ])
  ...
  it('separates community and non-community sources', async () => {
    vi.mocked(prisma.$queryRaw).mockResolvedValue([fakeRel])
    vi.mocked(prisma.relationshipSource.findMany).mockResolvedValue([
      { id: 'src-5', relationshipId: 'rel-1', source: 'TREFLE', sourceType: null, confidence: 'OBSERVED', url: 'https://trefle.io', notes: null, fetchedAt: new Date('2025-01-01'), userId: null, position: null },
      { id: 'src-6', relationshipId: 'rel-1', source: 'COMMUNITY', sourceType: null, confidence: 'ANECDOTAL', url: null, notes: 'testimony', fetchedAt: new Date('2025-06-01'), userId: 'user-1', position: null },
    ])
  ...
  it('does not expose userId in response', async () => {
    vi.mocked(prisma.$queryRaw).mockResolvedValue([fakeRel])
    vi.mocked(prisma.relationshipSource.findMany).mockResolvedValue([
      { id: 'src-7', relationshipId: 'rel-1', source: 'COMMUNITY', sourceType: null, confidence: 'ANECDOTAL', url: null, notes: 'test', fetchedAt: new Date('2025-06-01'), userId: 'user-1', position: null },
    ])
  ...
  it('includes sourceType on non-community sources', async () => {
    vi.mocked(prisma.$queryRaw).mockResolvedValue([fakeRel])
    vi.mocked(prisma.relationshipSource.findMany).mockResolvedValue([
      { id: 'src-8', relationshipId: 'rel-1', source: 'TREFLE', sourceType: 'SCIENTIFIC_PAPER', confidence: 'PEER_REVIEWED', url: 'https://trefle.io', notes: null, fetchedAt: new Date('2025-01-01'), userId: null, position: null },
    ])
